...
class NotificatiesType
{
    ...
    /**
     * @property \ToezichtS2S\Notificaties\v1\NotificatieType[] $notificatie
     */
    private $notificatie = [
     ...
     */
    public function addToNotificatie(\ToezichtS2S\Notificaties\v1\NotificatieType $notificatie)
    {
