...
class ZoekAntwoordType extends StandaardZoekAntwoordType
{
    ...
    /**
     * @property \ToezichtS2S\Service\Notificaties\v1\NotificatieType[] $notificaties
     */
     ...
     */
    public function addToNotificaties(\ToezichtS2S\Service\Notificaties\v1\NotificatieType $notificatie)
    {
     ...
     *
     * @param \ToezichtS2S\Service\Notificaties\v1\NotificatieType[] $notificaties
     * @return self
     */
