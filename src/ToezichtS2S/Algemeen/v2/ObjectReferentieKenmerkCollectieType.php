...
class ObjectReferentieKenmerkCollectieType
{
    ...
    /**
     * @property \ToezichtS2S\Algemeen\v2\ObjectReferentieKenmerkCollectieType\KenmerkAType[] $kenmerk
     */
    private $kenmerk = [
     ...
     */
    public function addToKenmerk(\ToezichtS2S\Algemeen\v2\ObjectReferentieKenmerkCollectieType\KenmerkAType $kenmerk)
    {
